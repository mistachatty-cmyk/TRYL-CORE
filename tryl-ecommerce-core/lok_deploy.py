...
MANIFEST = {
    ...
    "plugins/lokservices-bridge/lokservices-bridge.php": "tryl-ecommerce-core/lokservices-bridge.php",
    "mu-plugins/lokservices-bridge.php": "tryl-ecommerce-core/lokservices-bridge.php",
